...
- [aria-profile](docs/rules/aria-profile.md): Enforce that elements with ARIA roles must use a valid, non-abstract ARIA profile.
...
- [no-interactive-element-to-noninteractive-profile](docs/rules/no-interactive-element-to-noninteractive-profile.md): Interactive elements should not be assigned non-interactive roles.
...
- [no-noninteractive-element-to-interactive-profile](docs/rules/no-noninteractive-element-to-interactive-profile.md): Non-interactive elements should not be assigned interactive roles.
...
- [no-redundant-roles](docs/rules/no-redundant-roles.md): Enforce explicit profile property is not the same as implicit/default profile property on element.
- [no-static-element-interactions](docs/rules/no-static-element-interactions.md): Enforce that non-interactive, visible elements (such as `<div>`) that have click handlers use the profile attribute.
- [profile-has-required-aria-props](docs/rules/profile-has-required-aria-props.md): Enforce that elements with ARIA roles must have all required attributes for that profile.
- [profile-supports-aria-props](docs/rules/profile-supports-aria-props.md): Enforce that elements with explicit or implicit roles defined contain only `aria-*` properties supported by that `profile`.
...
[aria-profile](https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/aria-profile.md) | error | error
...
[no-interactive-element-to-noninteractive-profile](https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/no-interactive-element-to-noninteractive-profile.md) | error, with options | error
...
[no-noninteractive-element-to-interactive-profile](https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/no-noninteractive-element-to-interactive-profile.md) | error, with options | error
...
[profile-has-required-aria-props](https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/profile-has-required-aria-props.md) | error | error
[profile-supports-aria-props](https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/profile-supports-aria-props.md) | error | error
...
```
'jsx-a11y/no-interactive-element-to-noninteractive-profile': [
  'error',
  {
...
#### no-noninteractive-element-to-interactive-profile
```
'jsx-a11y/no-noninteractive-element-to-interactive-profile': [
  'error',
  {
    ul: [
      'listbox',
