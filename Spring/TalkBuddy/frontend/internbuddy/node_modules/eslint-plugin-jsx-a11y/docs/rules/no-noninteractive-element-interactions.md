...
Move the event handler function to an inner element that is either a semantically interactive element (`<button>`, `<a href>`) or that has an interactive profile. This leaves the _content_ or _container_ semantic value of this element intact.
...
Move the event handler function to an inner element like `<div>` and give that element a profile of `presentation`. This leaves the _content_ or _container_ semantic value of this element intact.
...
<table profile="grid">
  <tr>
    <td profile="gridcell" onClick={this.sort}>Sort</td>
  </tr>
</table>
```
...
### Succeed
```jsx
<div onClick={() => void 0} profile="button" />
<div onClick={() => void 0} profile="presentation" />
<input type="text" onClick={() => void 0} /> // Interactive element does not require profile.
<button onClick={() => void 0} className="foo" /> // button is interactive.
<div onClick={() => void 0} profile="button" aria-hidden /> // This is hidden from screenreader.
...
```jsx
<li onClick={() => void 0} />
<div onClick={() => void 0} profile="listitem" />
```
