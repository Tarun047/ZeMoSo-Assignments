...
- [ButtonBase] Fix anchors with href having a button profile (#16397) @eps1lon
...
- [Divider] Add aria profile if it's not implicit (#16256) @eps1lon
...
- [Chip] Fix profile prop when not clickable (#14365) @pandaiolo
...
- [LinearProgress] Add ARIA profile & fix bugs (#10069) @mbrookes
